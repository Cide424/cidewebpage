        ...
        ba_jQuery('.ba-gallery').each(function(){
            ...
            function checkPaginator()
            {
                ...
                if (pagination.pagination_type == 'default') {
                    ...
                    paginator.find('.ba-first-page, .ba-last-page, .ba-prev, .ba-next').show();
                    ...
                    paginator.find('a').not('.ba-first-page, .ba-last-page, .ba-prev, .ba-next').show();
                } else if (pagination.pagination_type == 'slider') {
                    paginator.find('.ba-prev, .ba-next').show();
                } else if (pagination.pagination_type == 'load') {
                    paginator.find('a').show();
                }
            }
