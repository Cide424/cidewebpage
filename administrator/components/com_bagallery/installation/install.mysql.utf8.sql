...
CREATE TABLE `#__bagallery_galleries` (
    ...
    `random_sorting` varchar(255) NOT NULL,
    ...
    `google_share` tinyint(1) NOT NULL DEFAULT 0,
    `pinterest_share` tinyint(1) NOT NULL DEFAULT 0,
    `linkedin_share` tinyint(1) NOT NULL DEFAULT 0,
    `vkontakte_share` tinyint(1) NOT NULL DEFAULT 0,
    `display_download` tinyint(1) NOT NULL DEFAULT 0,
    ...
    `display_zoom` tinyint(1) NOT NULL DEFAULT 0,
