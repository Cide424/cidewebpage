...
ALTER TABLE `#__bagallery_galleries` ADD `twitter_share` tinyint(1) NOT NULL DEFAULT 0;
ALTER TABLE `#__bagallery_galleries` ADD `facebook_share` tinyint(1) NOT NULL DEFAULT 0;
ALTER TABLE `#__bagallery_galleries` ADD `google_share` tinyint(1) NOT NULL DEFAULT 0;
ALTER TABLE `#__bagallery_galleries` ADD `pinterest_share` tinyint(1) NOT NULL DEFAULT 0;
ALTER TABLE `#__bagallery_galleries` ADD `linkedin_share` tinyint(1) NOT NULL DEFAULT 0;
ALTER TABLE `#__bagallery_galleries` ADD `vkontakte_share` tinyint(1) NOT NULL DEFAULT 0;
ALTER TABLE `#__bagallery_galleries` ADD `display_download` tinyint(1) NOT NULL DEFAULT 0;
...
ALTER TABLE `#__bagallery_galleries` ADD `display_zoom` tinyint(1) NOT NULL DEFAULT 0;
...
ALTER TABLE `#__bagallery_galleries` ADD `disable_right_clk` tinyint(1) NOT NULL DEFAULT 0;
