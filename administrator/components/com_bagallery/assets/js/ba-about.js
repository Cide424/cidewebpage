...
jQuery(document).ready(function(){
    ...
    function apdateComponent()
    {
        if (location.protocol == 'http:') {
            var src = 'http://www.balbooa.com/demo/index.php?option=com_baupdater&view=bagallery'
        } else {
            var src = 'index.php?option=com_bagallery&view=galleries&layout=upload&tmpl=component'
        }
    ...
    {
        if (event.origin == 'http://www.balbooa.com' || event.origin == location.origin) {
