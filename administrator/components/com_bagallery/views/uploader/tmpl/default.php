...
<script src="components/com_bagallery/assets/js/ba-uploader.js"></script>
    ...
    <form  target="form-target" action="<?php echo JRoute::_('index.php?option=com_bagallery&layout=uploader&id=&tmpl=component'); ?>"
        ...
        <div id="create-folder-modal" class="ba-modal-sm modal hide" style="display:none">
            <div class="modal-body">
                ...
                <input style="display: none;" type="file" multiple name="ba-files[]">
            ...
            <div class="row-fluid ba-media-header">
                ...
                ?>
                        ...
                        <div class="control-toolbar">
                            <label>
                                <i class="zmdi zmdi-forward" id="ba-apply"></i>
                                <span class="ba-tooltip ba-bottom"><?php echo JText::_('INSERT_SELECTED_ITEMS'); ?></span>
                            </label>
                            <label>
