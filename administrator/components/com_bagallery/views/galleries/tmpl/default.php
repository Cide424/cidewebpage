...
<script src="components/com_bagallery/assets/js/ba-about.js" type="text/javascript"></script>
...
<div id="language-dialog" class="modal hide ba-modal-lg" style="display:none">
    ...
    if (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') {
        echo '<iframe src="index.php?option=com_bagallery&view=galleries&layout=upload_language"></iframe>';
    } else {
        echo '<iframe src="http://www.balbooa.com/demo/index.php?option=com_baupdater&view=bagallery&layout=language"></iframe>';
    }
    ?>
    </div>
</div>
